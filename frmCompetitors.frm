...
Begin VB.Form frmCompetitors 
   ...
   Begin VB.CommandButton btnDelete 
      ...
      Height          =   495
      Left            =   9360
      Picture         =   "frmCompetitors.frx":0000
      TabIndex        =   10
      Top             =   6600
      Width           =   1095
   End
   ...
   Begin VB.CommandButton btnNew 
      ...
      Height          =   375
      Left            =   10560
      Picture         =   "frmCompetitors.frx":0442
      TabIndex        =   8
      Top             =   525
      Width           =   1095
   End
   Begin VB.CommandButton btnSave 
      ...
      Height          =   375
      Left            =   9360
      Picture         =   "frmCompetitors.frx":0884
      TabIndex        =   7
      Top             =   525
      Width           =   1095
   End
...
Private Sub btnNew_Click()
  ...
  rs.Update
  initForm
  Me.grdCompetitors.RowSel = Me.grdCompetitors.Rows - 1
  Me.grdCompetitors.EditRow Me.grdCompetitors.Rows - 1
...
Dim sqlstr As String
  ...
  sqlstr = sqlstr & " lastName as Achternaam, tel as telefoon, email as Email from tblCompetitors"
...
'  Me.Visible = False
  ...
  With Me.grdCompetitors
    .Redraw = False 'prevent screen flashing
    .Clear
    ...
    '.AutoSize 1, 5, FlexAutoSizeModeColWidth, FlexAutoSizeScopeAll, , 200
    Me.Width = Me.grdCompetitors.Width + 240
'    .GetSelRange 1, 3, .Rows, 3
    .Col = 3
    sortGrid Me.grdCompetitors
    .Redraw = True
  End With
 ' Me.Visible = True
End Sub
...
Private Sub grdCompetitors_BeforeRowColChange(ByVal NewRow As Long, ByVal NewCol As Long, Cancel As Boolean)
  'save record
  Dim i As Integer
  ...
  With Me.grdCompetitors
    ...
    rs.MoveFirst
    rs.Find "id = " & val(.TextMatrix(.Row, 0))
    If Not rs.EOF Then
      For i = 1 To rs.Fields.Count - 1
        rs.Fields(i) = .TextMatrix(.Row, i)
      Next
      rs.Update
    End If
  End With
...
Private Sub grdCompetitors_Click()
  With Me.grdCompetitors
    If .MouseRow = 0 Then 'sort
      sortGrid Me.grdCompetitors
    End If
  End With
End Sub
...
Private Sub grdCompetitors_RowColChange()
  ...
  'Debug.Print currentID, Me.grdCompetitors.TextMatrix(Me.grdCompetitors.Row, 1)
...
Private Sub grdCompetitors_ValidateEdit(Cancel As Boolean)
With Me.grdCompetitors
